...
| <a name="input_cron"></a> [cron](#input\_cron) | The cron expression (e.g. `0 1 * * *`) | `string` | n/a | yes |
...
| <a name="input_ref"></a> [ref](#input\_ref) | The branch/tag name to be triggered. This must be the full branch reference, for example: `refs/heads/main`, not `main` | `string` | n/a | yes |
